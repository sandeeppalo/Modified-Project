...
public class StaffController {
	...
	public ModelAndView registerStaff(@ModelAttribute("staff_Info") Staff_Info staff, 
		...
		try{
		    ...
		    if(!(RegistrationBO.registerStaffVName(staff.getStaff_Name())))
				throw new BusinessException("ERROR CODE 507:Invalid Student Name");	
