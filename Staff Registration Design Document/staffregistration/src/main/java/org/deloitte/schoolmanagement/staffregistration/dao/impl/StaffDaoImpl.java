...
public class StaffDaoImpl implements StaffDao{
	...
	public void registerStaffDetails(Staff_Info staff) {
		...
		System.out.println(staff.getDate_Of_Birth());
		System.out.println(staff.getAddress());
		System.out.println(staff.getCountry_Id());
		System.out.println(staff.getGender());
		System.out.println(staff.getSalary());
		System.out.println(staff.getContact_Number());
		System.out.println(staff.getEmail_Id());
		System.out.println(staff.getHighest_Qualification());
		System.out.println(StaffExperienceCategory.getExperienceCategory(staff.getDoj(),staff.getHighest_Qualification()));
		System.out.println(staff.getDesignation());
		System.out.println(staff.getYear_Passed_Out());
		session.save(staff);
		try {
			tx.commit();
